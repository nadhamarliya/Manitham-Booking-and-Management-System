...
const PatientSummary = () => {
  ...
  const handleOpenUpdateDrawer = (patient) => {
  ...
  const getStatusBadgeStyles = (status) => {
    switch (status) {
      ...
      case 'Inpatient': return 'bg-amber-50 text-amber-600 border border-amber-100';
      case 'Outpatient': return 'bg-indigo-50 text-indigo-600 border border-indigo-100';
      case 'Discharged': default: return 'bg-rose-50 text-rose-600 border border-rose-100';
    }
  };
    ...
    <div className="p-2 relative">
      ...
      {patients.length === 0 ? (
        <div className="bg-white border border-slate-100 rounded-2xl shadow-sm p-8 text-center min-h-[300px] flex flex-col items-center justify-center">
          ...
          <h3 className="text-base font-bold text-slate-700">No Patients Registered Yet</h3>
        </div>
